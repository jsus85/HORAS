       ...
       <!-- navbar side -->
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                 <!--  page header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Nuevo Tema de Interes</h1>
                </div>
                 <!-- end  page header -->
            </div>
            <div class="row">
                <div class="panel-heading">
                    <div class="form-group1">
                        ...
                        <div class="opci">
                        <div class="nuev"><a href="#" onclick="xajax_nuevoTemaInteres(xajax.getFormValues('form_nuevo'));"><img src="images/guar.png"> Guardar</a></div>
                    ...
                    <form id="form_nuevo" name="form_nuevo" method="post">
                        ...
                        <button type="button" onclick="xajax_nuevoTemaInteres(xajax.getFormValues('form_nuevo'));" class="btn1 btn-primary">Enviar</button>
                        </div>
                    </form>
                    </div>    
        </div>
