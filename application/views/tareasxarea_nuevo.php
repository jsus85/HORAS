              ...
              <div class="row">
                  ...
                  <h4><i class="fa fa-angle-right"></i> Tareas x Áreas</h4>
                   <div class="form-panel">
                      <h4 class="mb"><i class="fa fa-angle-right"></i> Nueva Tarea</h4>
                      <form class="form-horizontal style-form" method="post" action="<?php echo base_url('index.php/tareasxarea/add');?>">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <span class="help-block">Ingrese nombre de la tarea por favor.</span>
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <textarea id="descripcion" name="descripcion" class="form-control"><?php echo set_value('descripcion'); ?></textarea>
