            ...
            <div class="row">
                <div class="panel-heading">
                    <div class="form-group1">
                        ...
                        <div class="opci">
                        <div class="nuev"><a href="#" onclick="xajax_nuevoClientes(xajax.getFormValues('form_nuevo'));"><img src="images/guar.png"> Guardar</a></div>
                    ...
                    <form id="form_nuevo" name="form_nuevo" method="post" enctype="multipart/form-data">
                        ...
                        <button type="button" onclick="xajax_nuevoClientes(xajax.getFormValues('form_nuevo'));" class="btn1 btn-primary">Enviar</button>
                        </div>
                    </form>
                    </div>    
        </div>
