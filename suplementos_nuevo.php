       ...
       <!-- navbar side -->
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                 <!--  page header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Nuevo Suplemento</h1>
                </div>
                 <!-- end  page header -->
            </div>
            <div class="row">
                <div class="panel-heading">
                    <div class="form-group1">
                        ...
                        <div class="nuev"><a href="#" onclick="xajax_nuevoSuplementos(xajax.getFormValues('form_nuevo'));"><img src="images/guar.png"> Guardar</a></div>
                        <?php }?>
                    ...
                    <form id="form_nuevo" name="form_nuevo" method="post">
                        ...
                        <!-- Opciones nuevo editar-->
                        <?php if($_SESSION['sTipoUsuario']==1){?>    
                        <button type="button" onclick="xajax_nuevoSuplementos(xajax.getFormValues('form_nuevo'));" class="btn1 btn-primary">Enviar</button>
                        <?php }?>
                        </div>
                    </form>
                    </div>    
