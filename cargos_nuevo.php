            ...
            <div class="row">
                <div class="panel-heading">
                    <div class="form-group1">
                        ...
                        <div class="nuev"><a href="#" onclick="xajax_nuevoCargos(xajax.getFormValues('form_nuevo'));"><img src="images/guar.png"> Guardar</a></div>
                        <?php }?>
                    ...
                    <form id="form_nuevo" name="form_nuevo" method="post">
                        ...
                        <!-- Opciones nuevo editar-->
                        <?php if($_SESSION['sTipoUsuario']==1){?>    
                        <button type="button" onclick="xajax_nuevoCargos(xajax.getFormValues('form_nuevo'));" class="btn1 btn-primary">Enviar</button>
                        <?php }?>
                        </div>
                    </form>
                    </div>    
