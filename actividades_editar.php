            ...
            <div class="row">
                <div class="panel-heading">
                    <div class="form-group1">
                        ...
                        <div class="elim"><a href="EditarPeriodista-<?php echo $actividad[0]['periodista_id'];?>.html"><img src="images/cerr.png"> Cerrar</a></div>                        
                        </div> 
                    ...
                    <form id="form_nuevo" name="form_nuevo" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="HddID" id="HddID" value="<?php echo $_GET['id'];?>" />   
                         <input type="hidden" name="periodistas" id="periodistas" value="<?php echo $actividad[0]['periodista_id'];?>" /> 

                        <div class="form-group"><label>Buscar Periodista</label></div>
                        <div class="">                                            
                        <select id="HDDperiodistas" name="HDDperiodistas" class="form-control" disabled="disabled">
