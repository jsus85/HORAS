...
header("Content-Disposition: attachment;filename=\"detalle_eventos_".date("Y-m-d").".xls\"");
...
<body>
<p>&nbsp;</p>
<h5>PERIODISTA: <b><?php echo strtoupper($periodista[0]['nombres']." ".$periodista[0]['apellidos'])?></b></h5>
<?php
...
echo "<br /><p><b>TOTAL ASISTIDOS: ".$resultado."</p></b>";
