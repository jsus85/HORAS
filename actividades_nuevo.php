            ...
            <div class="row">
                <div class="panel-heading">
                    <div class="form-group1">
                        ...
                        <div class="elim"><a href="EditarPeriodista-<?php echo $_GET['periodista'];?>.html"><img src="images/cerr.png"> Cerrar</a></div>
                        </div> 
                    ...
                    <form id="form_nuevo" name="form_nuevo" method="post" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="periodistas" id="periodistas" value="<?php echo $_GET['periodista'];?>" />   
                        

                        <div class="form-group"><label>Buscar Periodista</label></div>
                        <div class="">                                            
                        <select disabled="disabled" id="HDDperiodistas" name="HDDperiodistas" class="form-control">
                        <option value="0">[Todos]</option>
                        <?php for($i=0;$i<count($periodistas);$i++){?>
                        <option <?php if($_GET['periodista']==$periodistas[$i]["id"]){?> selected <?php }?>  value="<?php echo $periodistas[$i]["id"];?>"><?php echo utf8_encode($periodistas[$i]["nombres"]);?></option>    
                        <?php }?>
                        </select>
                        </div>
