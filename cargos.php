...
$lista       = $model->datosCargos($nombres);
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                 <!--  page header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Mantenimientos de Cargos</h1>
                </div>
                 <!-- end  page header -->
            </div>
            <div class="row">
             <form action="cargos.php" id="form_buscar" name="form_buscar" method="post" accept-charset="utf-8">
                <div class="panel-heading">
                    <div class="form-group1">
                        ...
                        <div class="nuev"><a href="cargos_nuevo.php"><img src="images/nuev.png"> Nuevo</a></div>
                        <div class="elim"><a href="#" onclick="if(confirm('&iquest;Esta seguro de eliminar registro(s)?')) xajax_deleteCargos(xajax.getFormValues('form_buscar'));" ><img src="images/elim.png"> Eliminar</a></div>
                        </div>
                        <?php 
                                }
                        ?> 
                                ...
                                <div class="box-body table-responsive">
                                     ...
                                     <?php 
                                        ...
                                        <tr id="rw_<?php echo $lista[$i]["id"];?>" class="odd gradeX">
                                            ...
                                            <td><a title="Editar Cargos" href="cargos_editar.php?id=<?php echo $lista[$i]["id"];?>.html"><?php echo utf8_encode($lista[$i]["nombres"]);?></a></td>
